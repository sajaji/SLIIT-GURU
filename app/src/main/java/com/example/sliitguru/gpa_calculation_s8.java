...
public class gpa_calculation_s8 extends AppCompatActivity  {
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(updateinsertdata==true){
                    Toast.makeText(gpa_calculation_s8.this,"New Data Updated!",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(gpa_calculation_s8.this,"New Data Update Fail!",Toast.LENGTH_SHORT).show();
                }
                ...
                if(checkinsertdata==true){
                    Toast.makeText(gpa_calculation_s8.this,"New Data Inserted!",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(gpa_calculation_s8.this,"New Data Insertion Fail!",Toast.LENGTH_SHORT).show();
                }
    ...
    private void setSpinnerValues(String[] marks) {
        ...
        ArrayAdapter<String> adapter_m1= new ArrayAdapter<String>(gpa_calculation_s8.this, android.R.layout.simple_spinner_dropdown_item,marks);
        adapter_m1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        m1.setAdapter(adapter_m1);


        ArrayAdapter<String> adapter_m2= new ArrayAdapter<String>(gpa_calculation_s8.this, android.R.layout.simple_spinner_dropdown_item,marks);
        adapter_m1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        m2.setAdapter(adapter_m2);


        ArrayAdapter<String> adapter_m3= new ArrayAdapter<String>(gpa_calculation_s8.this, android.R.layout.simple_spinner_dropdown_item,marks);
        adapter_m1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        m3.setAdapter(adapter_m3);


        ArrayAdapter<String> adapter_m4= new ArrayAdapter<String>(gpa_calculation_s8.this, android.R.layout.simple_spinner_dropdown_item,marks);
        adapter_m1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        m4.setAdapter(adapter_m4);


        ArrayAdapter<String> adapter_m5= new ArrayAdapter<String>(gpa_calculation_s8.this, android.R.layout.simple_spinner_dropdown_item,marks);
        adapter_m1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        m5.setAdapter(adapter_m5);


        ArrayAdapter<String> adapter_m6= new ArrayAdapter<String>(gpa_calculation_s8.this, android.R.layout.simple_spinner_dropdown_item,marks);
        adapter_m1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        m6.setAdapter(adapter_m6);


        ArrayAdapter<String> adapter_m7= new ArrayAdapter<String>(gpa_calculation_s8.this, android.R.layout.simple_spinner_dropdown_item,marks);
        adapter_m1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
