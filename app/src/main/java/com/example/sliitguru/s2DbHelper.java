...
public class s2DbHelper extends SQLiteOpenHelper {
    public s2DbHelper(Context context) {
        //have to change db name
        super(context, "sem2.db", null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase DB) {
        //have to change table name
        DB.execSQL("create table semester2(n1 TEXT , n2 TEXT, n3 TEXT, n4 TEXT, n5 TEXT, n6 TEXT, n7 TEXT,m1 TEXT, m2 TEXT, m3 TEXT, m4 TEXT, m5 TEXT, m6 TEXT, m7 TEXT,c1 TEXT, c2 TEXT, c3 TEXT, c4 TEXT, c5 TEXT, c6 TEXT, c7 TEXT,gpa TEXT,credit TEXT)");
    ...
    public Boolean insertdata(String n1,String n2,String n3,String n4,String n5,String n6,String n7,String m1,String m2,String m3,String m4,String m5,String m6,String m7,String c1,String c2,String c3,String c4,String c5,String c6,String c7,String gpa,String credit){
        ...
        //have to change table name
        long result=DB.insert("semester2",null,contentValues);
        if(result==-1){
            return false;
        }
        else {
    ...
    public Boolean updatedata(String n1,String n2,String n3,String n4,String n5,String n6,String n7,String m1,String m2,String m3,String m4,String m5,String m6,String m7,String c1,String c2,String c3,String c4,String c5,String c6,String c7,String gpa,String credit){
        ...
        //have to change table name
        Cursor cursor=DB.rawQuery("select * from semester2 where n1=?", new String[]{n1});
        if(cursor.getCount()>0){

            //have to change table name
            long result=DB.update("semester2",contentValues,"n1=?",new String[]{n1});
            if(result==-1){
                return false;
            }
            else {
    ...
    public Cursor getdata(){
        SQLiteDatabase DB= this.getWritableDatabase();
        Cursor cursor=DB.rawQuery("select * from semester2",null);
        return cursor;
